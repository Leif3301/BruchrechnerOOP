...
namespace BruchrechnerOOP.View
{
    ...
    class Userinterface
    {
        ...
        public void GebeSplashScreenAus()
        {
            ...
            GebeTextAus(@" ____                               __                                 __                                 ");
            GebeTextAus(@"/\  _`\                            /\ \                               /\ \                                ");
            GebeTextAus(@"\ \ \L\ \   _ __   __  __    ___   \ \ \___     _ __     __     ___   \ \ \___      ___       __    _ __  ");
            GebeTextAus(@" \ \  _ <' /\`'__\/\ \/\ \  /'___\  \ \  _ `\  /\`'__\ /'__`\  /'___\  \ \  _ `\  /' _ `\   /'__`\ /\`'__\");
            GebeTextAus(@"  \ \ \L\ \\ \ \/ \ \ \_\ \/\ \__/   \ \ \ \ \ \ \ \/ /\  __/ /\ \__/   \ \ \ \ \ /\ \/\ \ /\  __/ \ \ \/ ");
            GebeTextAus(@"   \ \____/ \ \_\  \ \____/\ \____\   \ \_\ \_\ \ \_\ \ \____\\ \____\   \ \_\ \_\\ \_\ \_\\ \____\ \ \_\ ");
            GebeTextAus(@"    \/___/   \/_/   \/___/  \/____/    \/_/\/_/  \/_/  \/____/ \/____/    \/_/\/_/ \/_/\/_/ \/____/  \/_/ ");
            GebeTextAus(@"                                                                                                          ");
            GebeTextAus(@"                                                                                                          ");
            GebeTextAus(@"##########################################################################################################");
            GebeTextAus(@"########################################                   ###############################################");
